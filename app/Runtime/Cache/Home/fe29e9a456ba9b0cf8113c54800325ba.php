...
<!--     <div class="layui-breadcrumb crumbs shadow" lay-separator="/">         
    ...
    <div class="page-left">
        ...
        <?php else: ?>
            <?php if(empty($search)): ?><div class="blog-box-empty shadow">
                    <div class="l-content">未找到‘<em><?php echo ($param); ?></em>’相关的内容，请看下列热门文章</div>
                </div>
    ...
    <div class="l-footer">
        ...
        <?php if(is_array($search)): foreach($search as $k=>$art): if($art['auditing']): ?><div class="blog-box shadow">
    <div class="l-img"><img src="/static/img/small/<?php echo ($k+1); ?>.png"></div>
    <div class="l-box">
        <div class="tab">
            <?php switch($art['tag']): case "置顶": ?><span class="stick">置顶</span><?php break;?>
