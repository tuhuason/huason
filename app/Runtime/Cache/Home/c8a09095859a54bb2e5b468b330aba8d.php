...
<body>
    ...
    <div class="layui-breadcrumb crumbs shadow" lay-separator="/">         
        <a href="/">首页</a>
        <a href="<?php echo U('article/index');?>">文章</a><a>生活百科</a> 
    </div>
    <div class="page-left">
        <?php if(empty($data)): ?><div class="blog-box-empty shadow">
                <div class="l-content">暂无<em>生活百科</em>分类相关的文章</div>
            </div>
    ...
    <div class="clear"></div>
    <div class="l-footer">
        <span title="时间"><i class="layui-icon">&#xe60e;</i><?php echo (format_datetime($art["addtime"],2)); ?></span>
        <span title="作者"><i class="layui-icon">&#xe612;</i><?php echo ($username); ?></span>
        <span title="标签"><i class="layui-icon">&#xe600;</i><?php echo ($art["name"]); ?></span>
        <span class="info" title="查看次数"><i class="layui-icon">&#xe645;</i><?php echo ($art["hit"]); ?></span>
        <span class="info" title="评论数"><i class="layui-icon">&#xe611;</i><?php echo ($art["comment"]); ?></span>
    </div>
