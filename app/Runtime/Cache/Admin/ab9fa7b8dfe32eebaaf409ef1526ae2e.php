...
<button class="layui-btn" onclick="Reply_review.auditing_reviewes()"><i class="layui-icon" style="">&#xe605;</i>批量审核</button>
...
<table class="layui-table layui-form" id="reply_review">
    ...
    <col width="30">
  	...
  	<tbody>
        <?php if(is_array($reply)): foreach($reply as $key=>$re): ?><tr data-id="<?php echo ($re["id"]); ?>" data-content="<?php echo ($re["content"]); ?>">
            ...
            <td><?php echo ($re["article_id"]); ?></td>
	      	<td><?php echo ($re["reply_reviewer"]); ?></td>
            ...
            <td>
                <a class="layui-btn layui-btn-danger layui-btn-small delete_art" onclick="Reply_review.delete_review('<?php echo ($re["id"]); ?>','<?php echo ($re["identifier"]); ?>')"><i class="layui-icon" style="">&#xe640;</i></a>
            </td>
    ...
    <script type="text/javascript">
        $(function(){
            Base.initialize();
            Base.urls = {
    reply_review : "<?php echo U('Admin/ReplyReview/index');?>",
    delete_reply_review : "<?php echo U('Admin/ReplyReview/deleteReplyReview');?>",
    edit_reply_review : "<?php echo U('Admin/ReplyReview/editReplyReview');?>"
};
    ...
    <script type="text/javascript" src="/static/js/reply_review.js"></script>
    <script type="text/javascript">
    $(function(){
