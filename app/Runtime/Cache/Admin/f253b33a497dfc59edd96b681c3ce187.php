...
<table class="layui-table layui-form" id="review">
    ...
    <col width="30">
  	...
  	<tbody>
        <?php if(is_array($review)): foreach($review as $key=>$re): ?><tr data-id="<?php echo ($re["id"]); ?>" data-content="<?php echo ($re["content"]); ?>">
    ...
    editReview:"<?php echo U('Admin/review/editReview');?>"
};
